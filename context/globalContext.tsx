...
const GlobalContextProvider: FC<GlobalContextProps> = (props: GlobalContextProps) => {
  ...
  const [biasFactor, setBiasFactor] = useState<number>(0.005)
  ...
  const [preferredRange, setPreferredRange] = useState<number>(200)
  const [protectedRange, setProtectedRange] = useState<number>(60)
